...
const { convertMinSecToMs, convertKeyToKeyModeInt, getAudioFeatures, convertKeyToKeyMode, convertKeyModeIntToKey} = require('./library')
...
async function getSongs(number,category,order) {
    ...
    return songs.map(song => {
        ...
        console.log(typeof song.key)
        console.log(typeof song.mode)
        return song
    })
}
